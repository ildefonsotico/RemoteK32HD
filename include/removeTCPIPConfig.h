/*******************************************************************************
'*  EMPRESA    : DATASINC                                                      *
'*  DESCRIÇÃO  : Configuração da Stack TCP/IP                                  *
'*  PRODUTO    : DS-K32HD - Comutador da matriz HD (DS-M32HD e DS-M32As)       *
'*  PROJETISTA : Cristiano Tavares                                             *
'*  ARQUIVO    : TCPIPConfig.h         ESQUEMA: DS-K32HD.PrjPCb                *
'*  COMPILADOR : Microchip C30 3.12                                            *
...
'*-----------------------------------------------------------------------------*
'* 0.0      : aug/05/09 : Cristiano T. : Initial issue                         *
'*          :           :              :                                       *
'*          :           :              :                                       *
'******************************************************************************/
 ...
 */
#define MY_DEFAULT_HOST_NAME         "DS-K32HD17"     //Atualizar
...
#define MY_DEFAULT_MAC_BYTE6            (0x17)        //Atualizar

#define MY_DEFAULT_IP_ADDR_BYTE1        (192ul)//(192ul)
#define MY_DEFAULT_IP_ADDR_BYTE2        (168ul)//(168ul)
#define MY_DEFAULT_IP_ADDR_BYTE3        (100ul)//(0ul)
#define MY_DEFAULT_IP_ADDR_BYTE4        (22ul)//(52ul)    //Atualizar

#define MY_DEFAULT_MASK_BYTE1           (255ul)
#define MY_DEFAULT_MASK_BYTE2           (255ul)
#define MY_DEFAULT_MASK_BYTE3           (0ul)//(255ul)
#define MY_DEFAULT_MASK_BYTE4           (0ul)

#define MY_DEFAULT_GATE_BYTE1           (192ul)//(192ul)
#define MY_DEFAULT_GATE_BYTE2           (168ul)//(168ul)
#define MY_DEFAULT_GATE_BYTE3           (100ul)//(0ul)
#define MY_DEFAULT_GATE_BYTE4           (22ul)

#define MY_DEFAULT_PRIMARY_DNS_BYTE1    (192ul)//(192ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE2    (168ul)//(168ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE3    (100ul)//(0ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE4    (22ul)

#define MY_DEFAULT_SECONDARY_DNS_BYTE1   (0ul)//(192ul)
#define MY_DEFAULT_SECONDARY_DNS_BYTE2   (0ul)//(168ul)
#define MY_DEFAULT_SECONDARY_DNS_BYTE3   (0ul)
#define MY_DEFAULT_SECONDARY_DNS_BYTE4   (0ul)//(254ul)
 ...
 */
   ...
   #define TCP_ETH_RAM_SIZE               (1118ul)
   ...
   #define END_OF_TCP_SOCKET_TYPES
      ...
      } TCPSocketInitializer[] = 
      {
         ...
         {TCP_PURPOSE_TCP_PERFORMANCE_TX, TCP_ETH_RAM, 10, 1},
         {TCP_PURPOSE_TCP_PERFORMANCE_RX, TCP_ETH_RAM, 10, 1},
