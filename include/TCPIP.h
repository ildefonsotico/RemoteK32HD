...
#define VERSION       "v4.55"      // TCP/IP stack version
 ...
 *******************************************************************/
   ...
   #if ( (!defined(MPFS_USE_EEPROM) && !defined(STACK_USE_SPI_FLASH)) || defined(STACK_USE_MPFS2) ) && defined(STACK_USE_FTP)
